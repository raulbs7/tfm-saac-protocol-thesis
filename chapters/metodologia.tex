...
% La descripción técnica detallada de cada módulo del pipeline se desarrolla en el
% Capítulo~\ref{chap:desarrollo}, donde se presenta también la evaluación de resultados.
