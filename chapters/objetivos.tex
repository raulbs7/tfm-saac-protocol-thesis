...
\emph{few-shot} mediante \emph{Pattern-Exploiting Training} (\ac{PET}) sobre
\emph{BETO}~\cite{fewshot_clinical_nlp,beto_morphological}.
...
\cite{rag_lewis2020} ejecutada mediante un modelo de lenguaje local sobre
\emph{Ollama}~\cite{ollama}, que recupera los Turnos Comunicativos relevantes y los emplea para 
fundamentar el pre-rellenado de cada campo del formulario. Esta aproximación replica, para el dominio del
