...
\ac{SALT}, \ac{CLAN} o \ac{SUGAR}— han sido desarrolladas íntegramente en inglés y para
habla oral típica, sin contemplar ni el español ni los rasgos específicos del lenguaje
producido mediante pictogramas~\cite{lsa_computer_programs}. Esta carencia no es trivial:
...
requisito de procesamiento local de este trabajo.
