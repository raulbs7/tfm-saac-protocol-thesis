...
El \textbf{análisis de muestras de lenguaje} (\emph{Language Sample Analysis}, LSA) es
el protocolo estrella en logopedia para caracterizar las habilidades comunicativas
expresivas de una persona. Consiste en recoger una muestra representativa de la 
...
Para los usuarios de \ac{SAAC}, el LSA presenta desafíos específicos que los
protocolos existentes en inglés, fundamentalmente \ac{SALT} (\emph{Systematic
Analysis of Language Transcripts}) y CLAN/CHILDES, no estaban diseñados para abordar 
\cite{soto2022paalss_tutorial}. El lenguaje asistido no es simplemente habla oral 
...
como salida un formulario pre-rellenado con las métricas cuantitativas que el protocolo 
...
con un interlocutor, grabadas en vídeo. La evaluación de la precisión
del sistema se lleva a cabo comparando sus salidas con las anotaciones expertas
de dos sesiones reales del protocolo \cite{soto2024paalss_pilot}, lo que
establece un límite natural para la generalización de los resultados pero
permite una comparación directa con el estándar clínico de referencia.
...
para la decisión clínica (CP01); estructurar el trabajo en cinco objetivos específicos
